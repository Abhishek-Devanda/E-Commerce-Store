...
import { ShoppingCart, UserPlus, LogIn, LogOut, Lock, UserRound } from "lucide-react";
...
const Navbar = () => {
  ...
  return (
    <header className='fixed z-50 top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg transition-all duration-300 border-b border-emerald-800'>
      <div className='container mx-auto px-4 py-3'>
        <div className='flex flex-wrap justify-between items-center'>
          ...
          <nav className='flex flex-wrap items-center gap-4'>
            ...
            {isAdmin && (
              <Link to="/admin-dashboard" className='bg-emerald-700 hover:bg-emerald-600 text-white px-3 py-1 rounded-md font-medium transition duration-300 ease-in-out flex items-center'>
            ...
            {user ? (
              <>
                <Link to="/account" className='bg-emerald-700 hover:bg-emerald-600 text-white px-3 py-1 rounded-md font-medium transition duration-300 ease-in-out flex items-center'>
                  <UserRound className='inline-block mr-1' size={18} />
